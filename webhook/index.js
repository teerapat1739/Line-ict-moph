...
function handleMessageEvent(event) {
    ...
    if (eventText === 'qrcode') {
        ...
        msg = {
            'type': 'image',
            'originalContentUrl': `https://line-ict-moph.herokuapp.com/images/${event.source.userId}.png`,
            'previewImageUrl': `https://line-ict-moph.herokuapp.com/images/${event.source.userId}.png`
        }
